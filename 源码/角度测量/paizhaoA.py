...
import numpy as np
import time
RTSP_URLA = 'http://169.254.177.18:8080/?action=stream'  # A
RTSP_URLB = 'http://192.168.2.145:8080/?action=stream'  # B

#http://169.254.177.18:8080/?action=stream A
#http://169.254.35.15:8080/?action=stream B


capture = cv2.VideoCapture(RTSP_URLA)
...
while (True):
    ...
    cv2.imwrite("/home/pi/diansai/A.png", frame)
    break